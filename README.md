...
<p>
  ...
  <img src="https://img.shields.io/badge/Impressão_3D-FF6C00?style=for-the-badge&logo=makerbot&logoColor=white" alt="Impressão 3D" />
</p>
...
* 🌍 **[Medidor de Poluição (ICEB)](#)**
    * **Descrição:** Projeto de Iniciação Científica (2023/2024) focado no desenvolvimento de um dispositivo para aferição de qualidade do ar e índices de poluição.
    * **Tecnologias:** C/C++, Arduino, Integração de Sensores.

* ☀️ **[Seguidor Solar - Delta Solar](#)**
    * **Descrição:** Automação mecatrônica desenvolvida em 2023 para otimização de painéis fotovoltaicos, rastreando a posição do sol para maximizar a captação de energia.
    * **Tecnologias:** C/C++, Arduino, ESP32, Impressão 3D (Ender 3).

---

### 📫 Como me encontrar

* **LinkedIn:** [Juan Pablo Neves](https://www.linkedin.com/in/juan-pablo-neves-7602811b5)
* **E-mail:** [Juan_neves1@outlook.com](mailto:Juan_neves1@outlook.com)
